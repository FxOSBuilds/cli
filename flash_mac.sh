...
function adb_root() {
    ...
    ./adb.mac push newboot.img /sdcard/fxosbuilds/newboot.img
...
function downgrade_inari() {
    ...
    ./adb.mac push root/update-base-inari.zip /sdcard/fxosbuilds/update-base-inari.zip
...
function root_leo_ready() {
    ...
    ./adb.mac shell "rm /data/gpscfg/gps_env.conf 2>/dev/null"
    ./adb.mac shell "ln -s /data /data/gpscfg/gps_env.conf"
    ...
    ./adb.mac remount
    echo "Pushing SU"
    ./adb.mac push root/su /system/bin/su
    ./adb.mac shell "chmod 6755 /system/bin/su"
    ./adb.mac shell "ln -s /system/bin/su /system/xbin/su"
    echo "Cleaning up"
    ./adb.mac shell "rm /data/local.prop"
    ./adb.mac shell "rm /data/gpscfg/*"
    ./adb.mac shell "chmod 771 /data/"
    echo "Rebooting"
    ./adb.mac reboot
}
